...
export default function Contact() {
    return (
        <>
        <NavigationBar />
       <main id="contact-us-main" class="container">
        ...
        <section id="social-media-section" class="container">
            <h2>Connect With Us on Social Media</h2>
            <p>Follow us to stay updated on the latest products, deals, and news from Get-All!</p>
            <div class="social-icons">
                <a href="https://www.facebook.com/getall" target="_blank" class="social-icon-link">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.twitter.com/getall" target="_blank" class="social-icon-link">
                    <i class="fab fa-twitter"></i>
                </a>
                <a href="https://www.instagram.com/getall" target="_blank" class="social-icon-link">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="https://www.linkedin.com/company/getall" target="_blank" class="social-icon-link">
